...
<template>
	<v-card flat>
		<v-card-title class="mt-5 text-h3 font-weight-bold text-center py-5">{{
			propiedad?.titulo
		}}</v-card-title>
		...
		>
			...
			<v-card-text
				>Baños:
				<span class="font-weight-bold">{{ propiedad?.wc }}</span></v-card-text
			>
			<v-card-text
				>Estacionamiento:
				<span class="font-weight-bold">{{
